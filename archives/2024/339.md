...
updated_at: '2024-07-20 17:07:30'
labels:
  - 前端
  - JS
  - '2024'
...
我认为还是要再聊一聊 setTimeout 和 setInterval。
...
据查，Chrome 有做“自动修正”的处理（[源码](https://source.chromium.org/chromium/chromium/src/+/main:third_party/WebKit/Source/platform/Timer.cpp;drc=e6d900fb6ed08dbd3a048899f38962ee75f4d8d0;l=162)），即便是执行了 300 多次，甚至更多时，其漂移也很低，几乎可以忽略。尽管这种修正并不是规范所要求，但它应该是开发者想要的结果。
...
- `wx.getPerformance().now()` 返回自 1970 年 1 月 1 日 0 点开始以来的毫秒数。
