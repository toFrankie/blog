...
updated_at: '2024-08-25 18:22:33'
labels:
  - 前端
  - JS
  - '2024'
...
如果你想了解 Event Loop，推荐三个 JSConf 大会的演讲视频：
...
且线程之间相互独立，每个现场都有自己的 Event Loop，互不干扰。
