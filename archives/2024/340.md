...
updated_at: '2024-06-16 20:48:32'
labels:
  - 生活随笔
  - 前端
  - '2024'
...
使用 [pnpm create plasmo](https://www.npmjs.com/package/create-plasmo) 创建的项目，包含了以下 Script：
...
4. 开发时，可以将扩展固定在 Chrome 工具栏。


## 上传

准备好以下东西，执行 `pn package` 打包，前往[开发者信息中心](https://chrome.google.com/webstore/devconsole/)上传，填好相关信息提交审核即可。
