...
updated_at: '2024-12-14 00:15:38'
labels:
  - Mac
  - 持续更新
  - '2022'
...
按[此文](https://github.com/toFrankie/blog/issues/9)安装 Homebrew，无论是图形化界面应用，还是命令行工具，基本都能用它来安装。也可以用 `brew search <keyword>` 来搜索。

```shell
$ brew search google
==> Formulae
aws-google-auth                                google-go ✔                                    google-sql-tool
google-authenticator-libpam                    google-java-format                             googletest
google-benchmark                               google-sparsehash                              goose

==> Casks
google-ads-editor                              google-chrome@canary                           google-trends
google-analytics-opt-out                       google-chrome@dev                              google-web-designer
google-assistant                               google-cloud-sdk                               googleappengine
google-chat                                    google-drive                                   marshallofsound-google-play-music-player
google-chat-electron                           google-earth-pro                               moefe-google-translate
google-chrome                                  google-japanese-ime                            vpn-by-google-one
google-chrome@beta                             google-japanese-ime@dev
```
