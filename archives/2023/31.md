...
updated_at: '2023-11-27 14:10:39'
labels:
  - Mac
  - 持续更新...
  - '2022'
...
* [Dark Themer](https://github.com/toFrankie/terminal-theme)，一个自定义的 Dark Mode 系统终端描述文件，颜值还不错，配合 Oh My Zsh 味更佳。
* ...
...
使用「空格键」以快速预览是 macOS 的一大特色。可某些文件类型并不支持预览器内容，可通过安装插件的形式来扩展。请移步：[QuickLook 常用插件](https://www.jianshu.com/p/7421f7a03e07)。
...
安装与切换国内镜像源，看这篇文章即可：[Homebrew 使用详解，macOS 的第二个 Mac App Store!](https://zhuanlan.zhihu.com/p/30704752)。
...
相关链接：
* [Git 配置多个 SSH-Key](https://www.jianshu.com/p/86d65470f336)
...
👉 [为什么不推荐使用 cnpm？](https://www.jianshu.com/p/df1696de1d77)

**镜像源管理**

推荐 `nrm` 和 `yrm` 两个工具快速切换和管理镜像源。

> * [nrm 使用详解](https://www.jianshu.com/p/5ec39caa01cd)
> * [一个比 nrm 更好用的镜像源管理工具](https://www.jianshu.com/p/2a4b345f35a8)
