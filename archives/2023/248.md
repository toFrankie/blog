...
updated_at: '2024-06-10 21:31:54'
labels:
  - 代码片段
  - JS
  - '2021'
...
借助 ES6 的 [Rest 参数](https://es6.ruanyifeng.com/#docs/function#rest-参数)和[箭头函数](https://es6.ruanyifeng.com/#docs/function#箭头函数)语法，简化一下：
...
![节流处理](https://cdn.jsdelivr.net/gh/toFrankie/blog/images/1677411328715.png)
