...
updated_at: '2023-12-17 15:41:55'
labels:
  - Git
  - '2022'
---
...
在 VS Code 1.69 版本，它带来了 [3-way merge](https://code.visualstudio.com/updates/v1_69#_3-way-merge-editor) 方式。但似乎争议很大，至于好不好用，就见仁见智了。
...
操作完成后，保存文件。关闭该文件就表示 Merge Completed。如果有多个冲突文件，关闭这个会自动打开下一个。
