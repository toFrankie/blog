...
updated_at: '2023-04-26 22:20:56'
labels:
  - 尚未完结
  - JS
  - '2021'
...
> BTW，在 `Array.prototype.forEach()` 使用 `async/await` 可能得不到预期结果哦，详情看[文章](https://www.jianshu.com/p/17600665a51d)分析。
...
* [JavaScript ASI 机制详解](https://www.jianshu.com/p/05cd9981dc56)
