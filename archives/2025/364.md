...
updated_at: '2025-07-13 17:00:00'
labels:
  - '2025'
  - Tools
---
...
```json
{
  ...
  "icon": "icon.png", // 扩展图标
  "author": "tofrankie", // 务必确保是你的 Raycast 账户用户名
  "contributors": ["someone"], // 对扩展作出过贡献的 Raycast 用户名列表
  "license": "MIT", // 若要发布到 Store，只能是 MIT 协议
...
- **name**：需唯一，不能与 Store 已有扩展重复。发布后 `https://www.raycast.com/tofrankie/wechat-devtool`
- **icon**：必须存放到 `/assets` 目录。其他需要跟扩展一同打包的静态资源都要放在此目录下。
