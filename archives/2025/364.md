...
updated_at: '2025-08-25 17:55:24'
labels:
  - '2025'
  - Tools
---
...
- [showToast](https://developers.raycast.com/api-reference/feedback/toast) 有 Success、Failure、Animated 三张，后者为 Loading 圈圈。如果 Raycast 窗口关闭了，会回退到 showHUD
