...
updated_at: '2025-07-13 22:54:52'
labels:
  - '2025'
  - Tools
---
...
当命令设置了 view 模式，那么可以用官方提供的组件来构建界面。

- List 列表类型
- Grid 网格类型
- Detail 显示 Markdown 内容
- Form 表单类型

更多请看 [User Interface](https://developers.raycast.com/api-reference/user-interface)。
